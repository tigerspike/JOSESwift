...
public struct Decrypter {
    ...
    public init?<KeyType>(keyDecryptionAlgorithm: AsymmetricKeyAlgorithm, decryptionKey key: KeyType, contentDecryptionAlgorithm: SymmetricKeyAlgorithm) {
        ...
        case (.RSA1_5, .A256CBCHS512), (.RSAOAEP, .A256CBCHS512), (.RSAOAEP256, .A256CBCHS512), (.RSA1_5, .A128CBCHS256), (.RSAOAEP, .A128CBCHS256), (.RSAOAEP256, .A128CBCHS256), (.RSA1_5, .A256GCM), (.RSAOAEP, .A256GCM), (.RSAOAEP256, .A256GCM):
        ...
        case (.direct, .A256CBCHS512), (.direct, .A128CBCHS256), (.direct, .A256GCM):
